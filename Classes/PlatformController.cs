...
namespace DoodleJump.Classes
{
    public static class PlatformController
    {
        ...
        public static void GenerateRandomPlatform()
        {
            ...
            // Monte Carlo Simulation for bonus and enemy generation
            double randomValue = r.NextDouble(); // Generates a value between 0.0 and 1.0

            if (randomValue < 0.1) // 10% chance to create an enemy
            {
                CreateEnemy(platform);
            }
            else if (randomValue < 0.3) // 20% chance to create a bonus
            {
